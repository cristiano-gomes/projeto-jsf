...
public class HibernateUtil implements Serializable {
	...
	/**
	 * Responsavel por ler o arquivo de configuração hibernate.xml
	...
	private static SessionFactory buildSessionFactory(){
		try{
			...
			e.printStackTrace();
			throw new ExceptionInInitializerError("Erro ao criar conexao Session");
		}
	}
	...
	public DataSource getDataSourceJndi()throws NamingException{
		...
		return (DataSource) contex.lookup(VariavelConexaoUtil.JAVA_COMP_ENV_JDBC_DATA_SOURCE);
	}
